...
// runaway or hostile local endpoint. Over-limit bodies fail safe to "no full
// tunnel", consistent with the rest of this best-effort detector.
private const val TAILSCALE_MAX_STATUS_CHARS = 8 * 1024 * 1024
        ...
        return runCatching {
            ...
            try {
                ...
                val body = conn.inputStream.bufferedReader().use {
                    BoundedReader.readBounded(it, TAILSCALE_MAX_STATUS_CHARS)
                }
